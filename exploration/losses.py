...
def main(args):
    ...
    if args.evaluate_models:
        ...
        transformer_filtered_cov_lm_conv = bootstrap_mean_difference(
            -losses["TRANSFORMER_FILTERED_LM_COV_CONV"], -losses["TRANSFORMER_FILTERED"], N=1000, reduce=True
        )
